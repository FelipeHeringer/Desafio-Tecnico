...
('Itapiranga'),('Japurá'),('Juruá'),('Jutaí'),('Lábrea'),
...
('Urucará'),('Urucurituba');
-- Bahia (BA) - 417 municípios (sample principal)
INSERT INTO cidades (nome_cidade) VALUES
...
('Aporá'),('Apuarema'),('Araçás'),('Aracatu'),('Araci'),
...
('Contendas do Sincorá'),('Coração de Maria'),('Cordeiros'),('Coribe'),('Coronel João Sá'),
...
('Iaçu'),('Ibiassucê'),('Ibicaraí'),('Ibicoara'),('Ibicuí'),
('Ibipeba'),('Ibipitanga'),('Ibiquera'),('Ibirapitanga'),('Ibirapuã'),
('Ibirataia'),('Ibitiara'),('Ibititá'),('Ibotirama'),('Ichu'),
('Igaporã'),('Igrapiúna'),('Iguaí'),('Ilhéus'),('Inhambupe'),
('Ipecaetá'),('Ipiaú'),('Ipirá'),('Ipupiara'),('Irajuba'),
...
-- Ceará (CE) - 184 municípios (sample principal)
INSERT INTO cidades (nome_cidade) VALUES
...
('Araripe'),('Aratuba'),('Arneiroz'),('Assaré'),('Aurora'),
('Baixio'),('Banabuiú'),('Barbalha'),('Barreira'),('Barro'),
...
('Crato'),('Croatá'),('Cruz'),('Deputado Irapuan Pinheiro'),('Ereré'),
('Eusébio'),('Farias Brito'),('Forquilha'),('Fortaleza'),('Fortim'),
('Frecheirinha'),('General Sampaio'),('Graça'),('Granja'),('Granjeiro'),
('Groaíras'),('Guaiúba'),('Guaraciaba do Norte'),('Guaramiranga'),('Hidrolândia'),
...
-- Goiás (GO) - 246 municípios (sample principal)
INSERT INTO cidades (nome_cidade) VALUES
...
('Damianópolis'),('Damolândia'),('Davinópolis'),('Diorama'),('Doverlândia'),
('Edealina'),('Edéia'),('Estrela do Norte'),('Faina'),('Fazenda Nova'),
('Firminópolis'),('Flores de Goiás'),('Formosa'),('Formoso'),('Gameleira de Goiás'),
('Divinópolis de Goiás'),('Goianápolis'),('Goiandira'),('Goianésia'),('Goiânia'),
...
('São João d''Aliança'),('São João da Paraúna'),('São Luís de Montes Belos'),('São Luiz do Norte'),('São Miguel do Araguaia'),
...
('Vila Propício');
-- Maranhão (MA) - 217 municípios (sample principal)
INSERT INTO cidades (nome_cidade) VALUES
('Açailândia'),('Afonso Cunha'),('Água Doce do Maranhão'),('Alcântara'),('Aldeias Altas'),
('Altamira do Maranhão'),('Alto Alegre do Maranhão'),('Alto Alegre do Pindaré'),('Alto Parnaíba'),('Amapá do Maranhão'),
...
('Juscimeira'),('Lambari d''Oeste'),('Lucas do Rio Verde'),('Luciára'),('Marcelândia'),
...
('Nova Olímpia'),('Nova Ubiratã'),('Nova Xavantina'),('Novo Horizonte do Norte'),('Novo Mundo'),
...
('Pontes e Lacerda'),('Porto Alegre do Norte'),('Porto dos Gaúchos'),('Porto Esperidião'),('Porto Estrela'),
('Poxoréu'),('Primavera do Leste'),('Querência'),('Reserva do Cabaçal'),('Ribeirão Cascalheira'),
...
('São José do Rio Claro'),('São José do Xingu'),('São José dos Quatro Marcos'),('São Pedro da Cipa'),('Sapezal'),
...
-- Minas Gerais (MG) - 853 municípios (sample principal - seleção representativa)
INSERT INTO cidades (nome_cidade) VALUES
...
('Alterosa'),('Alto Caparaó'),('Alto Jequitibá'),('Alto Rio Doce'),('Alvarenga'),
('Alvinópolis'),('Alvorada de Minas'),('Amparo do Serra'),('Andradas'),('Andrelândia'),
('Angelândia'),('Antônio Carlos'),('Antônio Dias'),('Antônio Prado de Minas'),('Araçaí'),
...
('Bambuí'),('Bandeira'),('Bandeira do Sul'),('Barão de Cocais'),('Barão de Monte Alto'),
('Barbacena'),('Barra Longa'),('Barroso'),('Bela Vista de Minas'),('Belmiro Braga'),
('Belo Horizonte'),('Belo Oriente'),('Belo Vale'),('Berilo'),('Berizal'),
('Bertópolis'),('Betim'),('Bias Fortes'),('Bicas'),('Biquinhas'),
...
('Bonfim'),('Bonfinópolis de Minas'),('Bonito de Minas'),('Borda da Mata'),('Botelhos'),
('Botumirim'),('Brás Pires'),('Brasilândia de Minas'),('Brasília de Minas'),('Braúnas'),
...
('Caiana'),('Cajuri'),('Caldas'),('Camacho'),('Camanducaia'),
('Cambuí'),('Cambuquira'),('Campanário'),('Campanha'),('Campestre'),
('Campina Verde'),('Campo Azul'),('Campo Belo'),('Campo do Meio'),('Campo Florido'),
('Campos Altos'),('Campos Gerais'),('Cana Verde'),('Canaã'),('Canápolis'),
('Candeias'),('Cantagalo'),('Caparaó'),('Capela Nova'),('Capelinha'),
('Capetinga'),('Capim Branco'),('Capinópolis'),('Capitão Andrade'),('Capitão Enéas'),
('Capitólio'),('Caputira'),('Caraí'),('Caranaíba'),('Carandaí'),
('Carangola'),('Caratinga'),('Carbonita'),('Careaçu'),('Carlos Chagas'),
...
('Cataguases'),('Catas Altas'),('Catas Altas da Noruega'),('Catuji'),('Catuti'),
('Caxambu'),('Cedro do Abaeté'),('Central de Minas'),('Centralina'),('Chácara'),
('Chalé'),('Chapada do Norte'),('Chapada Gaúcha'),('Chiador'),('Cipotânea'),
('Claraval'),('Claro dos Poções'),('Cláudio'),('Coimbra'),('Coluna'),
('Comendador Gomes'),('Comercinho'),('Conceição da Aparecida'),('Conceição da Barra de Minas'),('Conceição das Alagoas'),
('Conceição das Pedras'),('Conceição de Ipanema'),('Conceição do Mato Dentro'),('Conceição do Pará'),('Conceição do Rio Verde'),
...
('Contagem'),('Coqueiral'),('Coração de Jesus'),('Cordisburgo'),('Cordislândia'),
('Corinto'),('Coroaci'),('Coromandel'),('Coronel Fabriciano'),('Coronel Murta'),
('Coronel Pacheco'),('Coronel Xavier Chaves'),('Córrego Danta'),('Córrego do Bom Jesus'),('Córrego Fundo'),
('Córrego Novo'),('Couto de Magalhães de Minas'),('Crisólita'),('Cristais'),('Cristália'),
('Cristiano Otoni'),('Cristina'),('Crucilândia'),('Cruzeiro da Fortaleza'),('Cruzília'),
...
('Diamantina'),('Diogo de Vasconcelos'),('Dionísio'),('Divinésia'),('Divino'),
('Divino das Laranjeiras'),('Divinolândia de Minas'),('Divinópolis'),('Divisa Alegre'),('Divisa Nova'),
('Divisópolis'),('Dom Bosco'),('Dom Cavati'),('Dom Joaquim'),('Dom Silvério'),
('Dom Viçoso'),('Dona Eusébia'),('Dores de Campos'),('Dores de Guanhães'),('Dores do Indaiá'),
('Dores do Turvo'),('Doresópolis'),('Douradoquara'),('Durandé'),('Elói Mendes'),
...
('Felixlândia'),('Fernandes Tourinho'),('Ferros'),('Fervedouro'),('Florestal'),
('Formiga'),('Formoso'),('Fortaleza de Minas'),('Fortuna de Minas'),('Francisco Badaró'),
('Francisco Dumont'),('Francisco Sá'),('Franciscópolis'),('Frei Gaspar'),('Frei Inocêncio'),
('Frei Lagonegro'),('Fronteira'),('Fronteira dos Vales'),('Fruta de Leite'),('Frutal'),
('Funilândia'),('Galiléia'),('Gameleiras'),('Glaucilândia'),('Goiabeira'),
('Goianá'),('Gonçalves'),('Gonzaga'),('Gouveia'),('Governador Valadares'),
...
('Heliodora'),('Iapu'),('Ibertioga'),('Ibiá'),('Ibiaí'),
('Ibiracatu'),('Ibiraci'),('Ibirité'),('Ibitiúra de Minas'),('Ibituruna'),
('Icaraí de Minas'),('Igarapé'),('Igaratinga'),('Iguatama'),('Ijaci'),
('Ilicínea'),('Imbé de Minas'),('Inconfidentes'),('Indaiabira'),('Indianópolis'),
('Ingaí'),('Inhapim'),('Inhaúma'),('Inimutaba'),('Ipaba'),
('Ipanema'),('Ipatinga'),('Ipiaçu'),('Ipuiúna'),('Iraí de Minas'),
('Itabira'),('Itabirinha'),('Itabirito'),('Itacambira'),('Itacarambi'),
('Itaguara'),('Itaipé'),('Itajubá'),('Itamarandiba'),('Itamarati de Minas'),
('Itambacuri'),('Itambé do Mato Dentro'),('Itamogi'),('Itamonte'),('Itanhandu'),
...
('Japonvar'),('Jeceaba'),('Jenipapo de Minas'),('Jequeri'),('Jequitaí'),
('Jequitibá'),('Jequitinhonha'),('Jesuânia'),('Joaíma'),('Joanésia'),
('João Monlevade'),('João Pinheiro'),('Joaquim Felício'),('Jordânia'),('José Gonçalves de Minas'),
('José Raydan'),('Josenópolis'),('Juatuba'),('Juiz de Fora'),('Juramento'),
('Juruaia'),('Juvenília'),('Ladainha'),('Lagamar'),('Lagoa da Prata'),
('Lagoa dos Patos'),('Lagoa Dourada'),('Lagoa Formosa'),('Lagoa Grande'),('Lagoa Santa'),
('Lajinha'),('Lambari'),('Lamim'),('Laranjal'),('Lassance'),
('Lavras'),('Leandro Ferreira'),('Leme do Prado'),('Leopoldina'),('Liberdade'),
('Lima Duarte'),('Limeira do Oeste'),('Lontra'),('Luisburgo'),('Luislândia'),
('Luminárias'),('Luz'),('Machacalis'),('Machado'),('Madre de Deus de Minas'),
('Malacacheta'),('Mamonas'),('Manga'),('Manhuaçu'),('Manhumirim'),
('Mantena'),('Mar de Espanha'),('Maravilhas'),('Maria da Fé'),('Mariana'),
...
('Matozinhos'),('Matutina'),('Medeiros'),('Medina'),('Mendes Pimentel'),
('Mercês'),('Mesquita'),('Minas Novas'),('Minduri'),('Mirabela'),
('Miradouro'),('Miraí'),('Miravânia'),('Moeda'),('Moema'),
...
('Nepomuceno'),('Ninheira'),('Nova Belém'),('Nova Era'),('Nova Lima'),
...
('Ouro Verde de Minas'),('Padre Carvalho'),('Padre Paraíso'),('Pai Pedro'),('Paineiras'),
('Pains'),('Paiva'),('Palma'),('Palmópolis'),('Papagaios'),
('Pará de Minas'),('Paracatu'),('Paraguaçu'),('Paraisópolis'),('Paraopeba'),
('Passa Quatro'),('Passa Tempo'),('Passa-Vinte'),('Passabém'),('Passos'),
('Patis'),('Patos de Minas'),('Patrocínio'),('Patrocínio do Muriaé'),('Paula Cândido'),
('Paulistas'),('Pavão'),('Peçanha'),('Pedra Azul'),('Pedra Bonita'),
('Pedra do Anta'),('Pedra do Indaiá'),('Pedra Dourada'),('Pedralva'),('Pedras de Maria da Cruz'),
('Pedrinópolis'),('Pedro Leopoldo'),('Pedro Teixeira'),('Pequeri'),('Pequi'),
('Perdigão'),('Perdizes'),('Perdões'),('Periquito'),('Pescador'),
('Piau'),('Piedade de Caratinga'),('Piedade de Ponte Nova'),('Piedade do Rio Grande'),('Piedade dos Gerais'),
...
('Ponto dos Volantes'),('Porteirinha'),('Porto Firme'),('Poté'),('Pouso Alegre'),
...
('Riacho dos Machados'),('Ribeirão das Neves'),('Ribeirão Vermelho'),('Rio Acima'),('Rio Casca'),
('Rio do Prado'),('Rio Doce'),('Rio Espera'),('Rio Manso'),('Rio Novo'),
('Rio Paranaíba'),('Rio Pardo de Minas'),('Rio Piracicaba'),('Rio Pomba'),('Rio Preto'),
('Rio Vermelho'),('Ritápolis'),('Rochedo de Minas'),('Rodeiro'),('Romaria'),
('Rosário da Limeira'),('Rubelita'),('Rubim'),('Sabará'),('Sabinópolis'),
('Sacramento'),('Salinas'),('Salto da Divisa'),('Santa Bárbara'),('Santa Bárbara do Leste'),
('Santa Bárbara do Monte Verde'),('Santa Bárbara do Tugúrio'),('Santa Cruz de Minas'),('Santa Cruz de Salinas'),('Santa Cruz do Escalvado'),
('Santa Efigênia de Minas'),('Santa Fé de Minas'),('Santa Helena de Minas'),('Santa Juliana'),('Santa Luzia'),
('Santa Margarida'),('Santa Maria de Itabira'),('Santa Maria do Salto'),('Santa Maria do Suaçuí'),('Santa Rita de Caldas'),
('Santa Rita de Ibitipoca'),('Santa Rita de Jacutinga'),('Santa Rita de Minas'),('Santa Rita do Itueto'),('Santa Rita do Sapucaí'),
('Santa Rosa da Serra'),('Santa Vitória'),('Santana da Vargem'),('Santana de Cataguases'),('Santana de Pirapama'),
('Santana do Deserto'),('Santana do Garambéu'),('Santana do Jacaré'),('Santana do Manhuaçu'),('Santana do Paraíso'),
('Santana do Riacho'),('Santana dos Montes'),('Santo Antônio do Amparo'),('Santo Antônio do Aventureiro'),('Santo Antônio do Grama'),
('Santo Antônio do Itambé'),('Santo Antônio do Jacinto'),('Santo Antônio do Monte'),('Santo Antônio do Retiro'),('Santo Antônio do Rio Abaixo'),
...
('São Gonçalo do Pará'),('São Gonçalo do Rio Abaixo'),('São Gonçalo do Rio Preto'),('São Gonçalo do Sapucaí'),('São Gotardo'),
('São João Batista do Glória'),('São João da Lagoa'),('São João da Mata'),('São João da Ponte'),('São João das Missões'),
('São João del Rei'),('São João do Manhuaçu'),('São João do Manteninha'),('São João do Oriente'),('São João do Pacuí'),
('São João do Paraíso'),('São João Evangelista'),('São João Nepomuceno'),('São Joaquim de Bicas'),('São José da Barra'),
('São José da Lapa'),('São José da Safira'),('São José da Varginha'),('São José do Alegre'),('São José do Divino'),
('São José do Goiabal'),('São José do Jacuri'),('São José do Mantimento'),('São Lourenço'),('São Miguel do Anta'),
('São Pedro da União'),('São Pedro do Suaçuí'),('São Pedro dos Ferros'),('São Romão'),('São Roque de Minas'),
('São Sebastião da Bela Vista'),('São Sebastião da Vargem Alegre'),('São Sebastião do Anta'),('São Sebastião do Maranhão'),('São Sebastião do Oeste'),
('São Sebastião do Paraíso'),('São Sebastião do Rio Preto'),('São Sebastião do Rio Verde'),('São Tiago'),('São Tomás de Aquino'),
('São Tomé das Letras'),('São Vicente de Minas'),('Sapucaí-Mirim'),('Sardoá'),('Sarzedo'),
...
('Serrania'),('Serranópolis de Minas'),('Serranos'),('Serro'),('Sete Lagoas'),
('Silva Xavier'),('Silveirânia'),('Silvianópolis'),('Simão Pereira'),('Simonésia'),
('Sobrália'),('Soledade de Minas'),('Tabuleiro'),('Taiobeiras'),('Taparuba'),
('Tapira'),('Tapiraí'),('Taquaraçu de Minas'),('Tarumirim'),('Teixeiras'),
...
('Veredinha'),('Veríssimo'),('Vermelho Novo'),('Vespasiano'),('Viçosa'),
...
('Salvaterra'),('Santa Bárbara do Pará'),('Santa Cruz do Arari'),('Santa Izabel do Pará'),('Santa Luzia do Pará'),
...
('Baraúna'),('Barra de Santa Rosa'),('Barra de Santana'),('Barra de São Miguel'),('Bayeux'),
('Belém'),('Belém do Brejo do Cruz'),('Bernardino Batista'),('Boa Ventura'),('Boa Vista'),
('Bom Jesus'),('Bom Sucesso'),('Bonito de Santa Fé'),('Boqueirão'),('Borborema'),
('Brejo do Cruz'),('Brejo dos Santos'),('Caaporã'),('Cabaceiras'),('Cabedelo'),
('Cachoeira dos Índios'),('Cacimba de Areia'),('Cacimba de Dentro'),('Cacimbas'),('Caiçara'),
('Cajazeiras'),('Cajazeirinhas'),('Caldas Brandão'),('Camalaú'),('Campina Grande'),
('Campo de Santana'),('Capim'),('Caraúbas'),('Carrapateira'),('Casserengue'),
...
('Curral Velho'),('Damião'),('Desterro'),('Diamante'),('Dona Inês'),
('Duas Estradas'),('Emas'),('Esperança'),('Fagundes'),('Frei Martinho'),
('Gado Bravo'),('Guarabira'),('Gurinhém'),('Gurjão'),('Ibiara'),
('Igaracy'),('Imaculada'),('Ingá'),('Itabaiana'),('Itaporanga'),
('Itapororoca'),('Itatuba'),('Jacaraú'),('Jericó'),('João Pessoa'),
...
('Santa Rita'),('Santa Teresinha'),('Santana de Mangueira'),('Santana dos Garrotes'),('Santarém'),
('Santo André'),('São Bentinho'),('São Bento'),('São Domingos de Pombal'),('São Domingos do Cariri'),
('São Francisco'),('São João do Cariri'),('São João do Tigre'),('São José da Lagoa Tapada'),('São José de Caiana'),
...
('Serra da Raiz'),('Serra Grande'),('Serra Redonda'),('Serraria'),('Sertãozinho'),
('Sobrado'),('Solânea'),('Soledade'),('Sossêgo'),('Sousa'),
('Sumé'),('Tacima'),('Taperoá'),('Tavares'),('Teixeira'),
('Tenório'),('Triunfo'),('Uiraúna'),('Umbuzeiro'),('Várzea'),
('Vieirópolis'),('Vista Serrana'),('Zabelê');
-- Paraná (PR) - 399 municípios (sample principal)
INSERT INTO cidades (nome_cidade) VALUES
('Abatiá'),('Adrianópolis'),('Agudos do Sul'),('Almirante Tamandaré'),('Altamira do Paraná'),
('Altônia'),('Alto Paraíso'),('Alto Paraná'),('Alto Piquiri'),('Alvorada do Sul'),
('Amaporã'),('Ampére'),('Anahy'),('Andirá'),('Ângulo'),
('Antonina'),('Antônio Olinto'),('Apucarana'),('Arapongas'),('Arapoti'),
...
('Bocaiúva do Sul'),('Bom Jesus do Sul'),('Bom Sucesso'),('Bom Sucesso do Sul'),('Borrazópolis'),
('Braganey'),('Brasilândia do Sul'),('Cafeara'),('Cafelândia'),('Cafezal do Sul'),
...
('Capanema'),('Capitão Leônidas Marques'),('Carambeí'),('Carlópolis'),('Cascavel'),
('Castro'),('Catanduvas'),('Centenário do Sul'),('Cerro Azul'),('Céu Azul'),
('Chopinzinho'),('Cianorte'),('Cidade Gaúcha'),('Clevelândia'),('Colombo'),
('Colorado'),('Congonhinhas'),('Conselheiro Mairinck'),('Contenda'),('Corbélia'),
('Cornélio Procópio'),('Coronel Domingos Soares'),('Coronel Vivida'),('Corumbataí do Sul'),('Cruz Machado'),
('Cruzeiro do Iguaçu'),('Cruzeiro do Oeste'),('Cruzeiro do Sul'),('Cruzmaltina'),('Curitiba'),
('Curiúva'),('Diamante d''Oeste'),('Diamante do Norte'),('Diamante do Sul'),('Dois Vizinhos'),
...
('Fazenda Rio Grande'),('Fênix'),('Fernandes Pinheiro'),('Figueira'),('Flor da Serra do Sul'),
('Floraí'),('Floresta'),('Florestópolis'),('Flórida'),('Formosa do Oeste'),
('Foz do Iguaçu'),('Foz do Jordão'),('Francisco Alves'),('Francisco Beltrão'),('General Carneiro'),
('Godoy Moreira'),('Goioerê'),('Goioxim'),('Grandes Rios'),('Guaíra'),
('Guairaçá'),('Guamiranga'),('Guapirama'),('Guaporema'),('Guaraci'),
('Guaraniaçu'),('Guarapuava'),('Guaraqueçaba'),('Guaratuba'),('Honório Serpa'),
('Ibaiti'),('Ibema'),('Ibiporã'),('Icaraíma'),('Iguaraçu'),
...
('Laranjal'),('Laranjeiras do Sul'),('Leópolis'),('Lidianópolis'),('Lindoeste'),
('Loanda'),('Lobato'),('Londrina'),('Luiziana'),('Lunardelli'),
...
('Maringá'),('Mariópolis'),('Maripá'),('Marmeleiro'),('Marquinho'),
('Marumbi'),('Matelândia'),('Matinhos'),('Mato Rico'),('Mauá da Serra'),
...
('Nova Santa Bárbara'),('Nova Santa Rosa'),('Nova Tebas'),('Novo Itacolomi'),('Ortigueira'),
('Ourizona'),('Ouro Verde do Oeste'),('Paiçandu'),('Palmas'),('Palmeira'),
('Palmital'),('Palotina'),('Paraíso do Norte'),('Paranacity'),('Paranaguá'),
('Paranapoema'),('Paranavaí'),('Pato Bragado'),('Pato Branco'),('Paula Freitas'),
('Paulo Frontin'),('Peabiru'),('Perobal'),('Pérola'),('Pérola d''Oeste'),
('Piên'),('Pinhais'),('Pinhal de São Bento'),('Pinhalão'),('Pinhão'),
('Piraí do Sul'),('Piraquara'),('Pitanga'),('Pitangueiras'),('Planaltina do Paraná'),
('Planalto'),('Ponta Grossa'),('Pontal do Paraná'),('Porecatu'),('Porto Amazonas'),
('Porto Barreiro'),('Porto Rico'),('Porto Vitória'),('Prado Ferreira'),('Pranchita'),
('Presidente Castelo Branco'),('Primeiro de Maio'),('Prudentópolis'),('Quarto Centenário'),('Quatiguá'),
('Quatro Barras'),('Quatro Pontes'),('Quedas do Iguaçu'),('Querência do Norte'),('Quinta do Sol'),
('Quitandinha'),('Ramilândia'),('Rancho Alegre'),('Rancho Alegre d''Oeste'),('Realeza'),
('Rebouças'),('Renascença'),('Reserva'),('Reserva do Iguaçu'),('Ribeirão Claro'),
('Ribeirão do Pinhal'),('Rio Azul'),('Rio Bom'),('Rio Bonito do Iguaçu'),('Rio Branco do Ivaí'),
('Rio Branco do Sul'),('Rio Negro'),('Rolândia'),('Roncador'),('Rondon'),
...
('Santa Mariana'),('Santa Mônica'),('Santa Tereza do Oeste'),('Santa Terezinha de Itaipu'),('Santana do Itararé'),
('Santo Antônio da Platina'),('Santo Antônio do Caiuá'),('Santo Antônio do Paraíso'),('Santo Antônio do Sudoeste'),('Santo Inácio'),
('São Carlos do Ivaí'),('São Jerônimo da Serra'),('São João'),('São João do Caiuá'),('São João do Ivaí'),
('São João do Triunfo'),('São Jorge d''Oeste'),('São Jorge do Ivaí'),('São Jorge do Patrocínio'),('São José da Boa Vista'),
('São José das Palmeiras'),('São José dos Pinhais'),('São Manoel do Paraná'),('São Mateus do Sul'),('São Miguel do Iguaçu'),
('São Pedro do Iguaçu'),('São Pedro do Ivaí'),('São Pedro do Paraná'),('São Sebastião da Amoreira'),('São Tomé'),
('Sapopema'),('Sarandi'),('Saudade do Iguaçu'),('Sengés'),('Serranópolis do Iguaçu'),
...
('Toledo'),('Tomazina'),('Três Barras do Paraná'),('Tunas do Paraná'),('Tuneiras do Oeste'),
('Tupãssi'),('Turvo'),('Ubiratã'),('Umuarama'),('União da Vitória'),
('Uniflor'),('Uraí'),('Ventania'),('Vera Cruz do Oeste'),('Verê'),
('Virmond'),('Vitorino'),('Wenceslau Braz'),('Xambrê');
-- Pernambuco (PE) - 185 municípios
INSERT INTO cidades (nome_cidade) VALUES
('Abreu e Lima'),('Afogados da Ingazeira'),('Afrânio'),('Agrestina'),('Água Preta'),
('Águas Belas'),('Alagoinha'),('Aliança'),('Altinho'),('Amaraji'),
('Angelim'),('Araçoiaba'),('Araripina'),('Arcoverde'),('Barra de Guabiraba'),
('Barreiros'),('Belém de Maria'),('Belém do São Francisco'),('Belo Jardim'),('Betânia'),
('Bezerros'),('Bodocó'),('Bom Conselho'),('Bom Jardim'),('Bonito'),
...
('Gameleira'),('Garanhuns'),('Glória do Goitá'),('Goiana'),('Granito'),
('Gravatá'),('Iati'),('Ibimirim'),('Ibirajuba'),('Igarassu'),
('Iguaracy'),('Inajá'),('Ingazeira'),('Ipojuca'),('Ipubi'),
('Itacuruba'),('Itaíba'),('Itambé'),('Itapetim'),('Itapissuma'),
('Itaquitinga'),('Jaboatão dos Guararapes'),('Jaqueira'),('Jataúba'),('Jatobá'),
('João Alfredo'),('Joaquim Nabuco'),('Jucati'),('Jupi'),('Jurema'),
('Lagoa do Carro'),('Lagoa do Itaenga'),('Lagoa do Ouro'),('Lagoa dos Gatos'),('Lagoa Grande'),
('Lajedo'),('Limoeiro'),('Macaparana'),('Machados'),('Manari'),
('Maraial'),('Mirandiba'),('Moreilândia'),('Moreno'),('Nazaré da Mata'),
('Olinda'),('Orobó'),('Orocó'),('Ouricuri'),('Palmares'),
...
('Curral Novo do Piauí'),('Demerval Lobão'),('Dirceu Arcoverde'),('Dom Expedito Lopes'),('Dom Inocêncio'),
...
('Nazaré do Piauí'),('Nazária'),('Nossa Senhora de Nazaré'),('Nossa Senhora dos Remédios'),('Nova Santa Rita'),
('Novo Oriente do Piauí'),('Novo Santo Antônio'),('Oeiras'),('Olho d''Água do Piauí'),('Padre Marcos'),
('Paes Landim'),('Pajeú do Piauí'),('Palmeira do Piauí'),('Palmeirais'),('Paquetá'),
('Parnaguá'),('Parnaíba'),('Passagem Franca do Piauí'),('Patos do Piauí'),('Pau d''Arco do Piauí'),
('Paulistana'),('Pavussu'),('Pedro II'),('Pedro Laurentino'),('Picos'),
('Pimenteiras'),('Pio IX'),('Piracuruca'),('Piripiri'),('Porto'),
...
('São Francisco de Assis do Piauí'),('São Francisco do Piauí'),('São Gonçalo do Gurguéia'),('São Gonçalo do Piauí'),('São João da Canabrava'),
('São João da Fronteira'),('São João da Serra'),('São João da Varjota'),('São João do Arraial'),('São João do Piauí'),
('São José do Divino'),('São José do Peixe'),('São José do Piauí'),('São Julião'),('São Lourenço do Piauí'),
('São Luís do Piauí'),('São Miguel da Baixa Grande'),('São Miguel do Fidalgo'),('São Miguel do Tapuio'),('São Pedro do Piauí'),
...
('Teresina'),('União'),('Uruçuí'),('Valença do Piauí'),('Várzea Branca'),
...
('Saquarema'),('Seropédica'),('Silva Jardim'),('Sumidouro'),('Tanguá'),
('Teresópolis'),('Trajano de Moraes'),('Três Rios'),('Valença'),('Varre-Sai'),
('Vassouras'),('Volta Redonda');
-- Rio Grande do Norte (RN) - 167 municípios
INSERT INTO cidades (nome_cidade) VALUES
('Acari'),('Açu'),('Afonso Bezerra'),('Água Nova'),('Alexandria'),
('Almino Afonso'),('Alto do Rodrigues'),('Angicos'),('Antônio Martins'),('Apodi'),
('Areia Branca'),('Arês'),('Augusto Severo'),('Baía Formosa'),('Baraúna'),
('Barcelona'),('Bento Fernandes'),('Bodó'),('Bom Jesus'),('Brejinho'),
('Caiçara do Norte'),('Caiçara do Rio do Vento'),('Caicó'),('Campo Redondo'),('Canguaretama'),
('Caraúbas'),('Carnaúba dos Dantas'),('Carnaubais'),('Ceará-Mirim'),('Cerro Corá'),
('Coronel Ezequiel'),('Coronel João Pessoa'),('Cruzeta'),('Currais Novos'),('Doutor Severiano'),
('Encanto'),('Equador'),('Espírito Santo'),('Extremoz'),('Felipe Guerra'),
('Fernando Pedroza'),('Florânia'),('Francisco Dantas'),('Frutuoso Gomes'),('Galinhos'),
('Goianinha'),('Governador Dix-Sept Rosado'),('Grossos'),('Guamaré'),('Ielmo Marinho'),
('Ipanguaçu'),('Ipueira'),('Itajá'),('Itaú'),('Jaçanã'),
...
('Pedra Grande'),('Pedra Preta'),('Pedro Avelino'),('Pedro Velho'),('Pendências'),
('Pilões'),('Poço Branco'),('Portalegre'),('Porto do Mangue'),('Pureza'),
('Rafael Fernandes'),('Rafael Godeiro'),('Riacho da Cruz'),('Riacho de Santana'),('Riachuelo'),
('Rio do Fogo'),('Rodolfo Fernandes'),('Ruy Barbosa'),('Santa Cruz'),('Santa Maria'),
('Santana do Matos'),('Santana do Seridó'),('Santo Antônio'),('São Bento do Norte'),('São Bento do Trairí'),
('São Fernando'),('São Francisco do Oeste'),('São Gonçalo do Amarante'),('São João do Sabugi'),('São José de Mipibu'),
...
('Serrinha dos Pintos'),('Severiano Melo'),('Sítio Novo'),('Taboleiro Grande'),('Taipu'),
...
-- Rio Grande do Sul (RS) - 497 municípios (continuação e completo)
INSERT INTO cidades (nome_cidade) VALUES
('João do Polêsine'),('Júlio de Castilhos'),('Lagoa Bonita do Sul'),('Lagoa dos Três Cantos'),('Lagoa Vermelha'),
('Lagoão'),('Lajeado'),('Lajeado do Bugre'),('Lavras do Sul'),('Liberato Salzano'),
('Lindolfo Collor'),('Linha Nova'),('Maçambará'),('Machadinho'),('Mampituba'),
('Manoel Viana'),('Maquiné'),('Maratá'),('Marau'),('Marcelino Ramos'),
...
('Nova Candelária'),('Nova Esperança do Sul'),('Nova Hartz'),('Nova Pádua'),('Nova Palma'),
...
('Novo Xingu'),('Osório'),('Paim Filho'),('Palmares do Sul'),('Palmeira das Missões'),
('Palmitinho'),('Panambi'),('Pântano Grande'),('Paraí'),('Paraíso do Sul'),
...
('Pinheirinho do Vale'),('Pinheiro Machado'),('Pinto Bandeira'),('Pirapó'),('Piratini'),
...
('Relvado'),('Restinga Sêca'),('Rio dos Índios'),('Rio Grande'),('Rio Pardo'),
...
('Santa Bárbara do Sul'),('Santa Cecília do Sul'),('Santa Clara do Sul'),('Santa Cruz do Sul'),('Santa Margarida do Sul'),
...
('Santo Antônio das Missões'),('Santo Antônio do Palma'),('Santo Antônio do Planalto'),('Santo Augusto'),('Santo Cristo'),
('Santo Expedito do Sul'),('São Borja'),('São Domingos do Sul'),('São Francisco de Assis'),('São Francisco de Paula'),
('São Gabriel'),('São Jerônimo'),('São João da Urtiga'),('São João do Polêsine'),('São Jorge'),
('São José das Missões'),('São José do Herval'),('São José do Hortêncio'),('São José do Inhacorá'),('São José do Norte'),
...
('São Nicolau'),('São Paulo das Missões'),('São Pedro da Serra'),('São Pedro das Missões'),('São Pedro do Butiá'),
('São Pedro do Sul'),('São Sebastião do Caí'),('São Sepé'),('São Valentim'),('São Valentim do Sul'),
('São Valério do Sul'),('São Vendelino'),('São Vicente do Sul'),('Sapiranga'),('Sapucaia do Sul'),
...
('Sobradinho'),('Soledade'),('Tabaí'),('Tapejara'),('Tapera'),
('Tapes'),('Taquara'),('Taquari'),('Taquaruçu do Sul'),('Tavares'),
('Tenente Portela'),('Terra de Areia'),('Teutônia'),('Tio Hugo'),('Tiradentes do Sul'),
('Toropi'),('Torres'),('Tramandaí'),('Travesseiro'),('Três Arroios'),
...
('Tupanci do Sul'),('Tupanciretã'),('Tupandi'),('Tuparendi'),('Turuçu'),
('Ubiretama'),('União da Serra'),('Unistalda'),('Uruguaiana'),('Vacaria'),
('Vale do Sol'),('Vale Real'),('Vale Verde'),('Vanini'),('Venâncio Aires'),
('Vera Cruz'),('Veranópolis'),('Vespasiano Corrêa'),('Viadutos'),('Viamão'),
('Vicente Dutra'),('Victor Graeff'),('Vila Flores'),('Vila Lângaro'),('Vila Maria'),
('Vila Nova do Sul'),('Vista Alegre'),('Vista Alegre do Prata'),('Vista Gaúcha'),('Vitória das Missões'),
('Westfália'),('Xangri-lá');
-- Rondônia (RO) - 52 municípios
INSERT INTO cidades (nome_cidade) VALUES
('Alta Floresta d''Oeste'),('Alto Alegre dos Parecis'),('Alto Paraíso'),('Alvorada d''Oeste'),('Ariquemes'),
('Buritis'),('Cabixi'),('Cacaulândia'),('Cacoal'),('Campo Novo de Rondônia'),
...
('Ministro Andreazza'),('Mirante da Serra'),('Monte Negro'),('Nova Brasilândia d''Oeste'),('Nova Mamoré'),
('Nova União'),('Novo Horizonte do Oeste'),('Ouro Preto do Oeste'),('Parecis'),('Pimenta Bueno'),
...
-- Santa Catarina (SC) - 295 municípios
INSERT INTO cidades (nome_cidade) VALUES
...
('Petrolândia'),('Balneário Piçarras'),('Pinhalzinho'),('Pinheiro Preto'),('Piratuba'),
('Planalto Alegre'),('Pomerode'),('Ponte Alta'),('Ponte Alta do Norte'),('Ponte Serrada'),
...
('São Bonifácio'),('São Carlos'),('São Cristóvão do Sul'),('São Domingos'),('São Francisco do Sul'),
...
('Sombrio'),('Sul Brasil'),('Taió'),('Tangará'),('Tigrinhos'),
...
('Xaxim'),('Zortéa');
-- São Paulo (SP) - 645 municípios (sample representativo - 300 municípios principais)
INSERT INTO cidades (nome_cidade) VALUES
...
('Emilianópolis'),('Engenheiro Coelho'),('Espírito Santo do Pinhal'),('Espírito Santo do Turvo'),('Estrela d''Oeste'),
('Estrela do Norte'),('Euclides da Cunha Paulista'),('Fartura'),('Fernandópolis'),('Fernando Prestes'),
...
('Guarani d''Oeste'),('Guarantã'),('Guararapes'),('Guararema'),('Guaratinguetá'),
('Guareí'),('Guariba'),('Guarujá'),('Guarulhos'),('Guatapará'),
...
('Igarapava'),('Igaratá'),('Iguape'),('Ilhabela'),('Ilha Comprida'),
('Ilha Solteira'),('Indaiatuba'),('Indiana'),('Indiaporã'),('Inúbia Paulista'),
...
('Pedra Bela'),('Pedranópolis'),('Pedregulho'),('Pedreira'),('Pedrinhas Paulista'),
('Pedro de Toledo'),('Penápolis'),('Pereira Barreto'),('Pereiras'),('Peruíbe'),
...
('União Paulista'),('Urânia'),('Uru'),('Urupês'),('Valentim Gentil'),
...
('Propriá'),('Riachão do Dantas'),('Riachuelo'),('Ribeirópolis'),('Rosário do Catete'),
...
('Cariri do Tocantins'),('Carmolândia'),('Carrasco Bonito'),('Caseara'),('Centenário'),
('Chapada da Natividade'),('Chapada de Areia'),('Colinas do Tocantins'),('Colméia'),('Combinado'),
('Conceição do Tocantins'),('Couto Magalhães'),('Cristalândia'),('Crixás do Tocantins'),('Darcinópolis'),
...
('Natividade'),('Nazaré'),('Nova Olinda'),('Nova Rosalândia'),('Novo Acordo'),
...
('Pedro Afonso'),('Peixe'),('Pequizeiro'),('Pindorama do Tocantins'),('Piraquê'),
('Pium'),('Ponte Alta do Bom Jesus'),('Ponte Alta do Tocantins'),('Porto Alegre do Tocantins'),('Porto Nacional'),
('Praia Norte'),('Presidente Kennedy'),('Pugmil'),('Recursolândia'),('Riachinho'),
('Rio da Conceição'),('Rio dos Bois'),('Rio Sono'),('Sampaio'),('Sandolândia'),
('Santa Fé do Araguaia'),('Santa Maria do Tocantins'),('Santa Rita do Tocantins'),('Santa Rosa do Tocantins'),('Santa Tereza do Tocantins'),
('Santa Terezinha do Tocantins'),('São Bento do Tocantins'),('São Félix do Tocantins'),('São Miguel do Tocantins'),('São Salvador do Tocantins'),
('São Sebastião do Tocantins'),('São Valério'),('Silvanópolis'),('Sítio Novo do Tocantins'),('Sucupira'),
('Taguatinga'),('Taipas do Tocantins'),('Talismã'),('Taveira'),('Tocantínia'),
